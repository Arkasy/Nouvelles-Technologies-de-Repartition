...
public class ApiController {
    ...
    private @ResponseBody
    Collection<Operation> getOperationOfAccount(@RequestParam String accountId) {
        BankAccount currentBankAccount = bankAccountRepo.findById(Integer.parseInt(accountId));
